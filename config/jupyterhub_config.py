...
c.JupyterHub.port = int(os.environ["JUPYTERHUB_PORT_INTERNAL"])
...
c.LocalGitHubOAuthenticator.oauth_client_id = os.environ['OAUTH_CLIENT_ID']
c.LocalGitHubOAuthenticator.oauth_client_secret = os.environ['OAUTH_CLIENT_SECRET']
